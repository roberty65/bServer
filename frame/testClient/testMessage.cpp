...
int main(int argc, char **argv)
{
	...
	}
	{
		unsigned char buf[1]; Message msg(buf, sizeof buf); 
		uint8_t a = 0x69, b = 1; 
		msg.writeUint8(a); EQUAL(msg.wptr, 1); msg.readUint8(b); EQUAL(msg.rptr, 1); EQUAL(a, b);
		a = 0x99, b = 1; 
		msg.reset();
		msg.writeUint8(a); EQUAL(msg.wptr, 1); msg.readUint8(b); EQUAL(msg.rptr, 1); EQUAL(a, b);
	}

	{
		...
		msg.writeInt16(a); EQUAL(msg.wptr, 2); msg.readInt16(b); EQUAL(msg.rptr, 2); EQUAL(a, b);
		a = 0x99f3, b = 1;
		msg.reset();
		msg.writeInt16(a); EQUAL(msg.wptr, 2); msg.readInt16(b); EQUAL(msg.rptr, 2); EQUAL(a, b);
	}
	{
		...
		msg.writeUint16(a); EQUAL(msg.wptr, 2); msg.readUint16(b); EQUAL(msg.rptr, 2); EQUAL(a, b);
		a = 0x99fb, b = 1; 
		msg.reset();
		msg.writeUint16(a); EQUAL(msg.wptr, 2); msg.readUint16(b); EQUAL(msg.rptr, 2); EQUAL(a, b);
	}
	  
	{
		...
		msg.writeInt32(a); EQUAL(msg.wptr, 4); msg.readInt32(b); EQUAL(msg.rptr, 4); EQUAL(a, b);
		a = 0x99f3abcd, b = 1;
		msg.reset();
		msg.writeInt32(a); EQUAL(msg.wptr, 4); msg.readInt32(b); EQUAL(msg.rptr, 4); EQUAL(a, b);
	}
	{
		...
		msg.writeUint32(a); EQUAL(msg.wptr, 4); msg.readUint32(b); EQUAL(msg.rptr, 4); EQUAL(a, b);
		a = 0x99fbdeff, b = 1; 
		msg.reset();
		msg.writeUint32(a); EQUAL(msg.wptr, 4); msg.readUint32(b); EQUAL(msg.rptr, 4); EQUAL(a, b);
	}

	{
		...
		msg.writeInt64(a); EQUAL(msg.wptr, 8); msg.readInt64(b); EQUAL(msg.rptr, 8); EQUAL(a, b);
	...
	}
	{
		...
		msg.writeUint64(a); EQUAL(msg.wptr, 8); msg.readUint64(b); EQUAL(msg.rptr, 8); EQUAL(a, b);
